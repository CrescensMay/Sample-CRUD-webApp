...
public class EditServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        printWriter.print("<div class=\"index\">\n" +
                ...
                "    <form action=\"EditServlet2\" id=\"employee\" method=\"post\">\n" +
                "        <input type=\"hidden\" id=\"userid\" name=\"id\" value='"+ employee.getId() +"'/><br>\n" +
                "        <label for=\"user\">Name</label><br>\n" +
                "        <input type=\"text\" id=\"user\" name=\"username\" value='"+ employee.getName() +"'/><br>\n" +
                "        <label for=\"useremail\">Email</label><br>\n" +
                "        <input type=\"email\" id=\"useremail\" name=\"email\" value='"+employee.getEmail()+"'/><br>\n" +
                "        <label for=\"userpassword\">Password</label><br>\n" +
                "        <input type=\"password\" id=\"userpassword\" name=\"password\" value='"+employee.getPassword()+"'/><br>\n" +
        ...
        printWriter.print(" $(\"#save\").click(function () {\n" +
                ...
                "   });");
        printWriter.print("</script>");
        printWriter.print("<script src=\"script.js\"></script>\n");
        printWriter.print("</body>");
        printWriter.print("</html>");
        printWriter.close();
    }
